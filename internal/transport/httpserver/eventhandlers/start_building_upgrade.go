...
func StartBuildingUpgrade(eventService EventService) func(c *gin.Context) {
	return func(c *gin.Context) {
		...
		finishTime, err := eventService.StartBuildingUpgrade(c.Request.Context(), userID, req.PlanetID, req.BuildingID)
		if err != nil {
